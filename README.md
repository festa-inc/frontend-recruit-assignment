## 기본 안내
- 과제 제출 방법: 본 레포지토리에 코드를 push
- 과제는 최소 면접 4시간 전 까지 푸쉬
- 과제 진행 중 문의 사항은 **메일을 받은 쓰레드로 문의 하세요.** 메일을 보낼 때 cc포함 전체 답장은 필수 입니다.
- 과제 수행 기간: 처음 레포지토리 개설 후 72시간 내
...
- 적절한 주석처리 (너무 과한 주석은 지양)  
- 패키지 관리를 위해 `npm` 혹은 `yarn` 사용 - 현재 프로젝트는 npm을 사용하였음
